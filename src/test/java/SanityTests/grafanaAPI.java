...
{
    @Test(priority = 0, description = "Add New Team And Verify")
    ...
    @Test(priority = 1, description = "Get Team Property")
    ...
    @Test(priority = 2, description = "Update Team Properties And Verify")
    ...
    @Test(priority = 3, description = "Delete Team And Verify")
